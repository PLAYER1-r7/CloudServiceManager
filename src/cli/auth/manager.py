...
class CloudAuthManager:
    ...
    def get_auth(
        self, provider: str, auto_initialize: bool = True, **kwargs
    ) -> CloudAuthBase:
    ...
    def initialize_provider(self, provider: str, **kwargs) -> CloudAuthBase:
    ...
    def validate_all(self) -> Dict[str, bool]:
        ...
        """
        return {
            provider: auth.validate() for provider, auth in self._auth_instances.items()
        }
    ...
    def refresh_all(self) -> Dict[str, bool]:
        ...
        """
        return {
            provider: auth.refresh() for provider, auth in self._auth_instances.items()
        }
