...
class AzureProvider:
    ...
    def __init__(self, auth: Optional[AzureAuth] = None, subscription_id: Optional[str] = None):
        ...
        self.compute_client = ComputeManagementClient(
            credential=self.auth._credential,
        ...
        try:
            ...
            for rg in resource_groups_list:
                ...
                try:
                    ...
                    logger.error(f"Error fetching VMs from resource group {rg.name}: {e}")
                except Exception as e:
