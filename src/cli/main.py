...
def list_services(
    ...
    region: Optional[str] = typer.Option(
        None, "--region", "-r", help="Filter by region (provider-specific)"
    ),
...
def get_service(
    provider: str = typer.Option(
        ..., "--provider", "-p", help="Cloud provider (aws, gcp, or azure)"
    ),
    service_id: str = typer.Option(..., "--id", "-i", help="Service identifier"),
    format: OutputFormat = typer.Option(
