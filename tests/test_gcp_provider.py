...
class TestGCPProvider:
    ...
    def test_list_services_multiple_zones(self, gcp_provider, mock_auth, mock_instance):
        ...
        instance2.machine_type = (
            "projects/test-project/zones/us-central1-b/machineTypes/n1-standard-2"
        )
    ...
    def test_list_services_permission_denied_single_zone(
        self, gcp_provider, mock_instance
    ):
    ...
    def test_convert_to_cloud_service_without_network_interfaces(self, gcp_provider):
        ...
        instance.machine_type = (
            "projects/test/zones/us-central1-a/machineTypes/n1-standard-1"
        )
