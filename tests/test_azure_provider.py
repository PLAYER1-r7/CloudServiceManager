...
class TestAzureProvider:
            ...
            with patch("src.cli.providers.azure.ComputeManagementClient"):
                with patch("src.cli.providers.azure.ResourceManagementClient"):
                    ...
                    mock_auth_class.assert_called_once_with(
                        subscription_id="test-subscription-456"
                    )
    ...
    def test_list_services_single_region(
        ...
        azure_provider.compute_client.virtual_machines.instance_view.return_value = (
            mock_instance_view
        )
    ...
    def test_list_services_multiple_resource_groups(
        ...
        # Mock VMs
        azure_provider.compute_client = Mock()
        azure_provider.compute_client.virtual_machines.list.side_effect = [
            [mock_vm],
            [vm2],
        ]
        azure_provider.compute_client.virtual_machines.instance_view.return_value = (
    ...
    def test_list_services_auth_error(self, azure_provider):
        ...
        azure_provider.resource_client = Mock()
        azure_provider.resource_client.resource_groups.list.side_effect = (
    ...
    def test_convert_to_cloud_service_without_hardware_profile(
        self, azure_provider, mock_instance_view
    ):
    ...
    def test_convert_to_cloud_service_with_unknown_power_state(
        self, azure_provider, mock_vm
    ):
