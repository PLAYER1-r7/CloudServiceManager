...
class TestGCPAuth:
    ...
    @patch("src.cli.auth.gcp_auth.default")
    @patch("src.cli.auth.gcp_auth.compute_v1.ZonesClient")
    def test_validate_failure_no_credentials(
        self, mock_zones_client_class, mock_auth_default
    ):
    ...
    @patch("src.cli.auth.gcp_auth.default")
    @patch("src.cli.auth.gcp_auth.compute_v1.ZonesClient")
    def test_validate_failure_api_error(
        self, mock_zones_client_class, mock_auth_default
    ):
    ...
    @patch("src.cli.auth.gcp_auth.default")
    def test_get_credentials_object_raises_when_not_authenticated(
