...
class TestAWSProvider:
    ...
    def test_list_services_single_region(self, aws_provider, mock_auth, mock_ec2_client):
    ...
    def test_list_services_all_regions(self, aws_provider, mock_auth, mock_ec2_client):
        ...
        mock_auth.get_session.return_value.client.side_effect = create_client_side_effect
    ...
    def test_list_services_handles_unauthorized_region(self, aws_provider, mock_auth, mock_ec2_client):
        ...
        def create_client_side_effect(service, region_name=None):
            ...
            if service == "ec2":
                if region_name == "us-east-1":
                    ...
                    client.describe_instances.side_effect = ClientError(error_response, "describe_instances")
            return client
    ...
    def test_get_all_regions_failure_fallback(self, aws_provider, mock_auth, mock_ec2_client):
